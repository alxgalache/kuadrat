...
SHALL NO mostrar la sección si `product.type !== 'Físico'` (obras digitales no llevan CoA físico).
...
- **THEN** la sección "Certificado de Autenticidad" SHALL NO renderizarse.
