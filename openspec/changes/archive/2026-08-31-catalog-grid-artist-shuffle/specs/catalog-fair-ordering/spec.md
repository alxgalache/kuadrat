...
La ordenación SHALL cubrirse con tests automáticos en `api/tests/` que verifiquen, como mínimo: determinismo, que la salida es una permutación exacta de la entrada, la invariante de no contigüidad y el reparto de la primera posición sobre muchas semillas.
