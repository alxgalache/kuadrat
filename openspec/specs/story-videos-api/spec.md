# story-videos-api Specification

## Purpose
Endpoint público que lista los story videos almacenados en S3 bajo el prefijo `stories/` y los sirve desde CloudFront en la página de inicio.
