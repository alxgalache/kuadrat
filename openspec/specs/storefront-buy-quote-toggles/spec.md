# storefront-buy-quote-toggles

## Purpose

Controlar mediante flags de entorno build-time si el storefront muestra el botón de compra ("Añadir a la cesta") o el de solicitud de cotización ("Solicitar cotización") en las fichas de obra (`/galeria/p/[id]`) y de producto other (`/tienda/p/[id]`). Permite desactivar el flujo de compra directa en determinados entornos o periodos sin cambiar código.
