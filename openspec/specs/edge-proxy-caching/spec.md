# edge-proxy-caching Specification

## Purpose
Comportamiento del nginx de producción como terminador de TLS y caché en disco delante de los contenedores. Cubre dónde vive su configuración, cómo se construye la clave de caché para las dos variantes que el App Router sirve bajo la misma URL, y cómo degrada el sitio cuando el origen se satura: sirviendo contenido antiguo en lugar de cortar la conexión.
