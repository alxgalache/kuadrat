...
Definir cómo un visitante se suscribe a la newsletter desde el storefront: el punto de entrada en el footer, el banner de primera visita, el modal de suscripción con topics, la validación y envío desde el cliente, y el endpoint público del backend que verifica el captcha, aplica anti-abuso, mapea los topics a preferencias de suscripción y da de alta/actualiza el contacto en Resend bajo el circuit breaker de marketing.
