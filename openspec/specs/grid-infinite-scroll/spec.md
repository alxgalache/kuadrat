...
Hacer fiable la carga incremental de las rejillas de producto con scroll infinito (`/galeria`, `/tienda`, `/galeria/autor/[authorSlug]` y `/tienda/autor/[authorSlug]`) en navegadores móviles con barra dinámica, donde comparar magnitudes de viewport no converge, y evitar que un fallo de carga o una respuesta sin aportación conviertan la rejilla en un bucle de peticiones o en una pantalla rota. Las cuatro rutas comparten un único componente de pie de rejilla responsable del centinela, el indicador de carga, el control manual y el aviso de error.
