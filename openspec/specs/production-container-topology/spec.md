# production-container-topology Specification

## Purpose
Cómo se reparten los recursos de la instancia de producción entre los contenedores y el nginx del anfitrión, y con qué imagen se despliega cada servicio. nginx no vive en un contenedor pero necesita CPU: termina TLS y sirve la caché en disco, de modo que los límites de los contenedores tienen que dejarle margen.
