...
* **Known blind spot, unfixed:** ~40 000 failed requests during the test produced **zero Sentry issues**. The overload failure mode is invisible to monitoring, and `proxy_cache_use_stale` makes a dead origin *less* visible from outside, not more.
