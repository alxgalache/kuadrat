...
const navigation = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/140dart',
    icon: (props) => (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/140dart',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Pinterest',
    href: 'https://pinterest.com/140dart',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="mb-8 md:mb-0 md:ml-8 flex justify-center gap-x-6 md:order-2">
          {NEWSLETTER_ENABLED && (
            <button
              type="button"
            ...
            >
              <span className="sr-only">{NEWSLETTER_COPY.footerIconLabel}</span>
