...
function GalleryPageContent() {
  ...
  const { products, loading, error, page, isFading, loadMoreProps } = useGalleryProducts(artAPI, selectedAuthorSlug, restoration)
          ...
          <main className="flex-1" ref={productListRef}>
            <div className="py-12">
              <ProductGrid
                ...
                onViewAuthorBio={handleViewAuthorBio}
              />
              <GridLoadMore {...loadMoreProps} variant="art" gridName="galeria" />
            </div>
          </main>
        </div>
      </div>
