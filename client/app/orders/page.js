...
function OrdersPageContent() {
    ...
    // El monedero (saldo, comisiones, botón de cobro y aviso de Stripe
    // Connect) ya NO vive aquí: está en `/seller/monedero`, a través del
    // componente `components/seller/SellerWallet.js`
    // (seller-kind-artist-speaker). Esta pantalla habla solo de pedidos, que
    // es lo que su entrada de menú lleva diciendo desde siempre.
